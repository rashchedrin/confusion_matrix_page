window.LANGUAGES = {
  en: {
    ...
    strings: {
      ...
      shareLinkModalTitle: 'Shareable Link',
      shareLinkModalDescription: 'Copy this link to share your confusion matrix with all settings:',
      copyLink: 'Copy',
      ...
      stats: {
        ...
        trace: 'Trace',
        traceTip: 'Top: sum of diagonal elements (correctly classified instances).\n\nBottom: sum of elements not on the diagonal (off-diagonal sum).',
        offDiagonalSum: 'Off-diagonal sum',
        traceOverSumTotal: 'Trace/sum_total',
        traceOverSumTotalTip: 'Top: diagonal fraction (trace / sum of all cells).\n\nBottom: off-diagonal fraction (1 − trace/sum_total).',
        offDiagonalFraction: '1-Trace/sum_total',
  ...
  ru: {
    ...
    strings: {
      ...
      shareLinkModalTitle: 'Ссылка для sharing',
      shareLinkModalDescription: 'Скопируйте эту ссылку, чтобы поделиться матрицей ошибок со всеми настройками:',
      copyLink: 'Копировать',
      ...
      stats: {
        ...
        trace: 'След (Trace)',
        traceTip: 'Сверху: сумма диагональных элементов (верные классификации).\n\nСнизу: сумма элементов не на диагонали (внедиагональная сумма).',
        offDiagonalSum: 'Внедиагональная сумма',
        traceOverSumTotal: 'След/sum_total',
        traceOverSumTotalTip: 'Сверху: доля диагонали (след / сумма всех ячеек).\n\nСнизу: доля вне диагонали (1 − след/sum_total).',
        offDiagonalFraction: '1−След/sum_total',
